...
### 🎨 Визуальная документация (рекомендуется!)

Откройте **`docs/home.html`** в браузере для красивой визуальной документации:

- ✨ Современный дизайн с градиентами и анимациями
- 📱 Адаптивная вёрстка для всех устройств  
- 🎯 Понятная навигация без вложенных списков
- 💻 Подсветка кода и интерактивные диаграммы
...
- **[INDEX.md](./docs/INDEX.md)** — главная страница документации со ссылками на все разделы
- **[OVERVIEW.md](./docs/OVERVIEW.md)** — обзор проекта, архитектура, технологический стек
- **[SERVER.md](./docs/SERVER.md)** — серверная часть, API endpoints, игровая логика
- **[CLIENT.md](./docs/CLIENT.md)** — клиентская часть, компоненты, роутинг
- **[GAMES.md](./docs/GAMES.md)** — подробное описание всех игр
- **[AUTH.md](./docs/AUTH.md)** — система аутентификации
- **[SOCIAL.md](./docs/SOCIAL.md)** — социальные функции (друзья, чаты, кланы)
- **[SUBSCRIPTION.md](./docs/SUBSCRIPTION.md)** — система подписки VIP/PRO
- **[DESIGN.md](./docs/DESIGN.md)** — дизайн, UI компоненты, анимации
- **[DEPLOY.md](./docs/DEPLOY.md)** — деплой на VPS, настройка окружения
- **[DATABASE.md](./docs/DATABASE.md)** — схема базы данных, модели Prisma
- **[STATS.md](./docs/STATS.md)** — статистика и достижения

### 🔧 Обновление документации

После редактирования `.md` файлов запустите:
```bash
