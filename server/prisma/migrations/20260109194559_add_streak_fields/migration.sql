...
INSERT INTO "new_Player" ("avatarUrl", "chaosClearProgress", "id", "joinedAt", "lastSeen", "name", "roomId", "shameClearProgress", "shameTitle", "status", "strikes") SELECT "avatarUrl", "chaosClearProgress", "id", "joinedAt", "lastSeen", "name", "roomId", "shameClearProgress", "shameTitle", "status", "strikes" FROM "Player";
DROP TABLE "Player";
